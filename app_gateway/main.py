...
from app_gateway.api.routers import (
    ...
    upgrade,  # NEW: Device software upgrade execution (2025-11-18 16:47:45 UTC)
...
try:
    if hasattr(upgrade, "upgrade_router"):
        ...
        logger.info("✅ Registered 'upgrade_router' (device software upgrade execution)")
        logger.info("   📍 Endpoints: POST /api/operations/upgrade, GET /api/operations/upgrade/health")
