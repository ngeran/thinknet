 ...
 * * This component contains only the PAGE CONTENT and NO layout elements 
 * (like sidebar, <main>, or the outer flex container).
 */
export default function Backup() {
  ...
  // ✅ Only return the content that should be rendered inside the main content area of the layout
  return (
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="results">
          <div className="space-y-6 p-6 border rounded-lg max-w-4xl">
            <h2 className="2xl font-bold flex items-center gap-3">
              {jobStatus === 'success' ? (
                <>
